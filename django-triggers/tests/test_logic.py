...
from django-triggers.logic import process_triggers
...
class AsynchronousExecutionTest(TestCase):
    ...
    def test_process_after_now(self):
        trigger = DummyTriggerFactory()
        with patch('django-triggers.logic.process_trigger.apply_async') as process_trigger_patch:
            process_triggers()
            process_trigger_patch.assert_called_once_with((trigger.id, 'django-triggers', 'DummyTrigger'),
